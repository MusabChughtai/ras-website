  ...
  return (
    <section id="why-us" className="py-20 bg-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#aa0033_1px,transparent_1px)] bg-[size:3rem_3rem]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
            Why Choose <span className="text-[#aa0033]">RAS</span>?
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-[#2a2a2a] p-8 rounded-xl border border-gray-800 hover:border-[#aa0033] transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:shadow-[#aa0033]/20"
            >
